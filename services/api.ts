...
import { ANXIETY_DETOX_DAYS, GRATITUDE_JOURNEY_DAYS, PROVERBS_JOURNEY_DAYS, HEALING_JOURNEY_DAYS, OPEN_DOORS_JOURNEY_DAYS, RESTORATION_JOURNEY_DAYS, IMPOSSIBLE_CAUSES_JOURNEY_DAYS } from '../constants';
...
export const generatePrayer = async (mood: Mood): Promise<string> => {
  try {
    // Fix: Updated to direct API key usage following coding guidelines
