...
const ptChallengesList = [
  ...
  { id: 'faith-foundations', title: 'Alicerces da Fé', description: '10 dias construindo uma base sólida nos fundamentos cristãos.', days: 10, theme: 'Crescimento Espiritual' },
...
const ptChallengesMap = {
  ...
  'faith-foundations': { title: 'Alicerces da Fé' },
...
export const pt = {
  ...
  landing: {
    ...
    flixDesc: 'Enquanto o mundo tenta roubar a mente dos seus filhos com valores invertidos, o Shalom Flix entrega animações bíblicas exclusivas. Deixe-os mergulhar nas histórias de Davi, Noé e Jesus com artes que encantam e ensinam a verdade que liberta.',
    psalmsTitle: 'Salmos Explicados: Onde o Medo não tem Voz',
    psalmsDesc: 'A ansiedade aperta o peito? Mergulhe em análises profundas de Salmos como o 23 e o 91. Não apenas leitura, mas uma explicação detalhada sobre como aplicar essa proteção real na sua vida agora.',
    whatJesusTitle: '“Jesus queria que você soubesse...”',
    whatJesusDesc: 'Para aqueles dias em que você se sente indigno ou esquecido. Receba mensagens que falam diretamente ao que você está vivendo. É como se Ele estivesse sentado ao seu lado, te dando a direção que falta.',
